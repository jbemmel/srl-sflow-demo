...
Note: The Containerlab config file uses a [beta](https://github.com/jbemmel/srl-sflow-demo/blob/main/srl-test.yml#L50) feature to connect spine1 e1-3 to the Linux management network bridge, until containerlab release 0.13 comes out a beta binary is included in this repo
